...
public class DB {
    ...
    public DB() {
        ...
        ArrayList<CoachPosition> cposition = new ArrayList<CoachPosition>();
        cposition.add(CoachPosition.HC);
        Coach c1 = new Coach(new Date(1989,12,11), "Jens", "Urben", t1, new ArrayList<Match>(),cposition);
